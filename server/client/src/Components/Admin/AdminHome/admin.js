                ...
                <div className="content">
                    <div className="row">
                        <div className="ribbon-box">
                            <Link to="/admin/pendingnotes" className="block">
                                <div></div>
                        ...
                        <div className="ribbon-box">
                            <Link to="/admin/rejectnotes" className="block">
                        ...
                        <div className="ribbon-box">
                            <Link to="/admin/acceptnotes" className="block">
                        ...
                        <div className="ribbon-box">
                            <Link to="/admin/allnotes" className="block">
