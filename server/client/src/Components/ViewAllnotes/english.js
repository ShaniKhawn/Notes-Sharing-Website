...
export default function English() {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/viewallnotes")
      ...
      .then((data) => {
        // Filter notes with "accept" status and "english" branch
        const viewallnotes = data.filter((note) => note.status === "accept" && note.branch === "English");
    ...
    <>
      ...
      <div className="viewall-notes m-t">
        <div className="lrgcontainer">
            <h2 className="content-heading">English Notes</h2>
